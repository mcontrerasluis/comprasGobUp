package mx.gob.shcp.compras.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("comprasGobUp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("comprasGobUp");
        ...
        config.getMapConfigs().put("mx.gob.shcp.compras.domain.*", initializeDomainMapConfig(jHipsterProperties));
