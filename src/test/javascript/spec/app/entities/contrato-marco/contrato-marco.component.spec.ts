...
import { ContratoMarcoComponent } from 'app/entities/contrato-marco/contrato-marco.component';
...
describe('Component Tests', () => {
    describe('ContratoMarco Management Component', () => {
        let comp: ContratoMarcoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ContratoMarcoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.contratoMarcos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
