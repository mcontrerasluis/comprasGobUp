...
import { IFactura, Factura, EstatusFactura, MetodoPago } from 'app/shared/model/factura.model';
...
describe('Service Tests', () => {
    describe('Factura Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Factura(0, currentDate, 'AAAAAAA', EstatusFactura.PAGADA, MetodoPago.CREDITO, currentDate, 0);
        });
