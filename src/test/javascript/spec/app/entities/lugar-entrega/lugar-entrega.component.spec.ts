...
import { LugarEntregaComponent } from 'app/entities/lugar-entrega/lugar-entrega.component';
...
describe('Component Tests', () => {
    describe('LugarEntrega Management Component', () => {
        let comp: LugarEntregaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LugarEntregaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.lugarEntregas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
