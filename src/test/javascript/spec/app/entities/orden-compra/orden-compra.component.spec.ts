...
import { OrdenCompraComponent } from 'app/entities/orden-compra/orden-compra.component';
...
describe('Component Tests', () => {
    describe('OrdenCompra Management Component', () => {
        let comp: OrdenCompraComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OrdenCompraComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.ordenCompras[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
